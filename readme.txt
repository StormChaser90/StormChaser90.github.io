This is an "Etch-A-Sketch" project I did for The Odin Project (TOP). Below are the direction provided by TOP.

This project was a lot of fun to me. Challenging for sure, but I am happy with how it turned out. Turns out I didn't really follow the direction super closely. I started with the first couple and then just ran with it. 
